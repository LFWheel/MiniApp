...
var AppManager = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(AppManager, null, [{
    ...
    value: function getAppById(appId) {
      for (var i = 0; i < this.appStack.length; i++) {
    ...
    key: "closeApp",
    value: function closeApp(miniApp) {
...
var Bridge = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Bridge, [{
    ...
    key: "uiMessageHandler",
    value: function uiMessageHandler(msg) {
      var type = msg.type;
      switch (type) {
    ...
    key: "trrigerEvent",
    value: function trrigerEvent(msg) {
      var id = msg.id,
    ...
    key: "notifyMakeInitialData",
    value: function notifyMakeInitialData() {
      this.jscore.postMessage({
        ...
        return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              this.webview.addEventListener('message', _babel_runtime_corejs3_core_js_stable_instance_bind__WEBPACK_IMPORTED_MODULE_4___default()(_context2 = this.uiMessageHandler).call(_context2, this));
            case 4:
            case "end":
              return _context3.stop();
          }
    ...
    value: function createWebview() {
      ...
      return new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_5___default())(function (resolve) {
        ...
        _this.parent.webviewsContainer.appendChild(webview.el);
      });
    }
  }, {
    key: "setInitialData",
...
/* harmony import */ var _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime-corejs3/regenerator */ "./node_modules/@babel/runtime-corejs3/regenerator/index.js");
/* harmony import */ var _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_url__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/url */ "./node_modules/@babel/runtime-corejs3/core-js-stable/url.js");
...
var JSCore = /*#__PURE__*/function () {
  function JSCore() {
    ...
    this.parent = null;
    this.worker = null;
    this.event = (0,mitt__WEBPACK_IMPORTED_MODULE_5__["default"])();
  }
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(JSCore, [{
    ...
    value: function () {
      var _init = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
        var _this = this;
        var jsContent, codeString, jsBlob, urlObj;
        return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
            ...
            case 2:
              ...
              _context.next = 5;
              return jsContent.text();
            case 5:
              codeString = _context.sent;
              jsBlob = new Blob([codeString], {
                type: 'application/javascript'
              });
              urlObj = _babel_runtime_corejs3_core_js_stable_url__WEBPACK_IMPORTED_MODULE_4___default().createObjectURL(jsBlob);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./util */ "./src/core/miniAppSandbox/util.js");
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(MiniAppSandbox, [{
      ...
      var _initApp = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
        ...
        return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _context2.next = 4;
              return (0,_native_utils_util__WEBPACK_IMPORTED_MODULE_7__.sleep)(1000);
            case 4:
              // 2. 读取配置文件
              configPath = "".concat(this.appInfo.appId, "/config.json");
              _context2.next = 7;
              return (0,_util__WEBPACK_IMPORTED_MODULE_11__.readFile)(configPath);
            case 7:
              ...
              return this.createBridge({
                ...
                configInfo: (0,_util__WEBPACK_IMPORTED_MODULE_11__.mergePageConfig)(this.appConfig.app, pageConfig)
              });
            case 14:
    ...
    value: function () {
      var _createBridge = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2(opts) {
        var jscore, configInfo, isRoot, appId, pagePath, query, scene, bridge;
        return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              jscore = opts.jscore, configInfo = opts.configInfo, isRoot = opts.isRoot, appId = opts.appId, pagePath = opts.pagePath, query = opts.query, scene = opts.scene;
              bridge = new _native_core_bridge__WEBPACK_IMPORTED_MODULE_9__.Bridge({
                jscore: jscore,
    ...
    value: function updateTargetPageColorStyle(pagePath) {
      ...
      var mergeConfig = (0,_util__WEBPACK_IMPORTED_MODULE_11__.mergePageConfig)(this.appConfig.app, pageConfig);
    ...
    key: "hideLaunchScreen",
    value: function hideLaunchScreen() {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MiniAppList, [{
    ...
    value: function bindOpenMiniApp() {
      ...
      appList.onclick = function (e) {
        var app = (0,_native_utils_util__WEBPACK_IMPORTED_MODULE_6__.closest)(e.target, 'weixin-app__mini-used-list-item');
        if (!app) {
          return;
        }
        var appId = app.getAttribute('data-appid');
        var appInfo = _this2.getAppInfoByAppId(appId);
        if (!appInfo) {
          return;
        }
        _native_core_appManager_appManager__WEBPACK_IMPORTED_MODULE_7__.AppManager.openApp({
          appId: appId,
          path: appInfo.path,
          scene: 1001
        }, _this2.parent);
    ...
    key: "getAppInfoByAppId",
    value: function getAppInfoByAppId(appId) {
